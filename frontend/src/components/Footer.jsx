...
const Footer = () => {
  return (
    <footer className="bottom-0 w-screen max-h-56 min-h-32 flex flex-col items-center justify-center bg-slate-950 text-slate-500 font-alternative text-center">
